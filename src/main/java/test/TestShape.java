...
public class TestShape {
	...
	public static void main(String[] args) {
		...
		System.out.println("Creating Cicle with with thick line and color blue, fill in blue");
		Circle c = new Circle();
		...
		Shape circle2 = new FillColorDecorator(new LineColorDecorator(new Circle(), Color.YELLOW), Color.GREEN);
		circle2.draw();
		System.out.println();
